...
* [Farm.js](https://github.com/farming-labs/farm.js) - A full-stack React framework with streaming SSR, Server Actions, typed file-based routing and first-party product integrations.
